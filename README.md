...
- Timestamp: `2022-05-24 13:12`
- Build ID: `5a1d98ec-2e8f-4ccf-b0fb-c65056e6e95a`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5a1d98ec-2e8f-4ccf-b0fb-c65056e6e95a.git
$ cd 5a1d98ec-2e8f-4ccf-b0fb-c65056e6e95a
```
